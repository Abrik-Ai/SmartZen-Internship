...
class BackendClient:
    ...
    async def get_schedules(
        self, token: str, from_time: str | None = None, to_time: str | None = None
    ) -> list[Schedule]:
    ...
    async def get_empty_rooms(
        self, token: str, minutes: int, start: str | None = None
    ) -> list[EmptyRoom]:
        ...
        return [EmptyRoom.model_validate(item) for item in rooms_data]
